...
<section class="tipos-textos">
 ...
 <section class="tabla">
                ...
                <td bgcolor="#CCCCCC"  ><br>
                  ...
                  <thead>
                    <tr>
                      ...
                      <th width="7%" bgcolor="#313630" class="h5 style11"><div align="center">Subtotal</div></th>
                      <th width="5%" bgcolor="#313630" class="h5 style11"><div align="center">Tax</div></th>
	...
	$monto=0;
	$consulta="select  ventas.id,   ventas.pmb, ROUND(total,2) as total, tipo, date_format(ventas.fecha, '%m/%d/%Y'),ROUND(subtotal,2),ROUND(tax,2) from ventas where date(fecha)>='$fecha2' and date(fecha)<='$fecha_hasta2' $and   order by id";
	...
	while(@mysql_num_rows($resultado)>=$count)
	{
		...
		?>
                    <tr bgcolor="#<? echo"$color";?>">
                      ...
                      <td>
                        <div align="center"><a href="imprimir_venta.php?id=<? echo"$res[0]"?>" target="_blank" class="btn-primary"><? echo"$res[4]";?></a></div></td>
                      </tr>
...
?>
                   <tr bgcolor="#<? echo"$color";?>">
                      ...
                      <td>&nbsp;</td>
                      <td>&nbsp;</td>
                      <td><div align="center">$<? echo number_format(round($monto,2),2);?></div></td>
