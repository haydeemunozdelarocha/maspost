...
if($_POST['guardar']=="Guardar"){
		...
		$consulta3="insert into usuarios (nombre, email, pass, tipo) values ('".$_POST['nombre']."', '".$_POST['email']."', '".$_POST['pass']."', '".$_POST['adm']."')";
              ...
              <table width="488" align="center" class="">
                ...
                <tr class="">
                  ...
                  <td><div class="form-group">
                      <input name="pass" type="text" class="form-control" id="pass" size="10" maxlength="10" placeholder="" required>
                  </div></td>
                </tr>
                <tr class="">
                  <td class="verde">Email</td>
                  <td><span class="form-group">
                    <input name="email" type="text" class="form-control" id="email" size="10" maxlength="30" required>
                  </span></td>
                </tr>
                <tr class="">
                  <td class="verde">Administrador</td>
                  <td><span class="style5">Si
                    <input name="adm" type="radio" value="1" checked>
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;No
                    <input name="adm" type="radio" value="0">
                  </span></td>
                </tr>
                <tr class="">
