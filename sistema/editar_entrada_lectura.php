...
$consulta  = "select date_format(recepcion.fecha_recepcion, '%m/%d/%Y'), nombre, tipo, fletera, peso, traking, costo, extra, fromm, id_salida,pmb, no_paquetes_resto, no_paquetes,cod from recepcion where id=$id";
//echo"$consulta";
