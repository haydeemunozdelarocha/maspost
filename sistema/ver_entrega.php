...
$id=$_GET["id"];
	...
	$totalextra=0;
	$consulta  = "SELECT salidas.pmb, date_format(salidas.fecha, '%m/%d/%Y'), salidas.entrego, salidas.comentario,  salidas.total_s, salidas.total_p, salidas.descuento, salidas.credito, salidas.total  from salidas where id=$id ";
...
<table width="922" border="0" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <td width="69%">220 Basset<br />
      El Paso, TX 79901<br />
      Phone:(915) 351-81-60 </td>
  </tr>
  <tr>
    <td colspan="2" scope="row"><div align="left">
      <table width="100%" border="0" cellpadding="1" cellspacing="2">
        <tr>
          ...
          <td width="24%" bgcolor="#CCCCCC">RECOGE</td>
          <td width="16%" bgcolor="#CCCCCC">PAGO:</td>
          <td width="14%" bgcolor="#CCCCCC">FECHA:</td>
        ...
        <tr>
          ...
          <td bgcolor="#666666"><span class="style1">Descuento: $<? echo"$descuento";?> </span></td>
