...
<html class="no-js">
    <head>
        <meta charset="utf-8">
        <title>+Post Warehouse | Entradas por Día</title>
...
include "menu_f.php";    }?>
 ...
 <section class="tabla">
            ...
            <tbody>
              ...
              <tr class="">
                <td bgcolor="#CCCCCC"  ><table width="1056" class="tablesorter" id="myTable">
                  <thead>
                    <tr>
                      <th width="8%" bgcolor="#313630" class="h5"><div align="center" class="style11">                        Fecha</div></th>
                      ...
                      <th width="15%" bgcolor="#313630" class="h5"><div align="center" class="style11">                        From</div></th>
                      <th width="13%" bgcolor="#313630" class="h5"><div align="left" class="style11">
                        <div align="center">                          Recibe</div>
                      </div></th>
                      <th width="9%" bgcolor="#313630" class="h5"><div align="center" class="style11">Peso</div></th>
                      <th width="9%" bgcolor="#313630" class="h5"><div align="left" class="style11">
                      ...
                      <th width="6%" bgcolor="#313630" class="h5"><div align="center" class="style11">                        COD</div></th>

                      <th width="3%" bgcolor="#313630"><div align="center"><span class="style11"></span></div></th>
                    </tr>
                  </thead>
                  <tbody>
                    <?
	...
	$consulta="select recepcion.nombre, recepcion.fromm, date_format(recepcion.fecha_recepcion, '%m/%d/%Y'), tipo_entradas.nombre, fleteras.nombre, recepcion.peso, recepcion.traking, recepcion.pmb, recepcion.costo, usuarios.nombre, recepcion.id, TIMESTAMPDIFF(MONTH, fecha_recepcion, now()) as meses, TIMESTAMPDIFF(DAY,DATE_ADD(fecha_recepcion,INTERVAL TIMESTAMPDIFF(MONTH, fecha_recepcion, now()) MONTH), now()) as dias, recepcion.tipo, recepcion.cod, planes.tabla_pallets, entrada from recepcion inner join tipo_entradas on recepcion.tipo=tipo_entradas.id inner join fleteras on fleteras.id=recepcion.fletera inner join ubicacion on ubicacion.id=recepcion.ubicacion inner join usuarios on usuarios.id=recepcion.id_empleado_recibe left outer join clientes on clientes.pmb=recepcion.pmb left outer join planes on clientes.id_plan=planes.id where fecha_recepcion>='$fecha2' and fecha_recepcion<='$fecha_hasta2' $and order by recepcion.entrada";
//echo"$consulta";
	...
	while(@mysql_num_rows($resultado)>=$count)
	{
		...
		?>
                    <tr bgcolor="#<? echo"$color";?>">
                      <td><div align="center"><a href="editar_entrada.php?id=<? echo"$res[10]";?>&origen=2"  class="iframe2"><? echo"$res[2]";?></a></div></td>
