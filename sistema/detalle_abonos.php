...
<section class="tipos-textos">
      <h2 class="style12"> Detalle de Abonos </h2>
  </section>
 <section class="tabla">
      <div >
        <div >
              ...
              <tr class="">
                <td bgcolor="#CCCCCC"  ><br>
                  <table width="1056" class="tablesorter" id="myTable">
                    <thead>
                      <tr>
                        <th width="17%" bgcolor="#313630" class="h5"><div align="center" class="style11">Factura</div></th>
                        <th width="10%" bgcolor="#313630" class="h5"><div align="left" class="style11">
                            <div align="center"> PMB </div>
                        </div></th>
                        <th width="18%" bgcolor="#313630" class="h5"><div align="left" class="style11">
                            <div align="center"> Monto </div>
                        </div></th>
                        <th width="34%" bgcolor="#313630" class="h5"><div align="left" class="style11">
                            <div align="center"> Tipo Pago </div>
                        </div></th>
                        <th width="21%" bgcolor="#313630"><div align="center"><span class="style11">Fecha</span></div></th>
                      </tr>
                    </thead>
                    <tbody>
                      <?
	...
	$consulta="select  id,   pmb, monto, tipo, date_format(fecha, '%m/%d/%Y') from abonos  where date(fecha)>='$fecha2' and date(fecha)<='$fecha_hasta2' $and  order by id";
//echo"$consulta";
	...
	while(@mysql_num_rows($resultado)>=$count)
	{
		...
		?>
                      <tr bgcolor="#<? echo"$color";?>">
                        ...
                        <td><div align="center"><a href="imprimir_abono.php?id=<? echo"$res[0]"?>" target="_blank" class="btn-primary"><? echo"$res[4]";?></a></div></td>
                      </tr>
