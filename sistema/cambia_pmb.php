...
if($_POST['guardar']=="Guardar"){
		...
		$id=$_POST['id'];
		$consulta3="update pmbs set id='".$_POST['nombre']."' where id=$id";
		...
		echo"<script>alert(\"PMB Guardado\");</script>";
		echo"<script>parent.location=\"pmbs.php\";</script>";

}
$consulta  = "select * from pmbs order by id";
      ...
      <div >
        <div >
          ...
          <table width="400px" align="center" class="">
              ...
              <tr class="">
                <td class="verde">Numero				</td>
				<td><div class="form-group">
                          <input name="nombre" type="text" class="form-control" value="<? echo"$res[0]";?>" placeholder="Nombre" required>
                       </div>			    </td>
              </tr>
			  <tr class="">
