...
<html class="no-js">
    <head>
        <meta charset="utf-8">
        <title>+Post Warehouse | Salidas por Día</title>
...
include "menu_f.php";    }?>
 ...
 <section class="tabla">
          ...
          <table width="1031" align="center" cellspacing="2" class="">
            ...
            <tbody>
              <tr class="">
                ...
                <input name="pmb" type="text" class="texto_verde" id="pmb"  value="<?echo"$pmb";?>" size="10" maxlength="10" placeholder="PMB"/>
                ...
                <td bgcolor="#CCCCCC"  ><table width="1056" class="tablesorter" id="myTable">
                  <thead>
                    <tr>
                      ...
                      <th width="7%" bgcolor="#313630" class="h5"><div align="center" class="style11"> Salida                        </div></th>
                      <th width="5%" bgcolor="#313630" class="h5"><div align="center" class="style11">                        Tipo</div></th>
                      ...
                      <th width="5%" bgcolor="#313630" class="style11"><div align="center">Peso</div></th>
                      ...
                      <th width="3%" bgcolor="#313630" class="h5"><div align="left" class="style11">
                        <div align="center">                          Extra</div>
                      </div></th>
                      <th width="4%" bgcolor="#313630" class="h5"><div align="center" class="style11">                        COD</div></th>

                      <th width="7%" bgcolor="#313630"><div align="center"><span class="style11">Fecha</span></div></th>
                      <th width="11%" bgcolor="#313630"><div align="center"><span class="style11">SE ENTREGO  </span></div></th>
                    </tr>
                  </thead>
                  <tbody>
                    <?
	...
	if($pmb!="")
		$and=" and recepcion.pmb=$pmb ";
	else
		$and="";


	$consulta="select recepcion.nombre, recepcion.fromm, date_format(recepcion.fecha_recepcion, '%m/%d/%Y'), tipo_entradas.nombre, fleteras.nombre, recepcion.peso, recepcion.traking, recepcion.pmb, recepcion.costo, usuarios.nombre, recepcion.id, TIMESTAMPDIFF(MONTH, fecha_recepcion, now()) as meses, TIMESTAMPDIFF(DAY,DATE_ADD(fecha_recepcion,INTERVAL TIMESTAMPDIFF(MONTH, fecha_recepcion, now()) MONTH), now()) as dias, recepcion.tipo, recepcion.cod, planes.tabla_pallets, id_salida, extra, date_format(recepcion.fecha_entrega, '%m/%d/%Y'), entrego, recepcion.id_salida from recepcion inner join tipo_entradas on recepcion.tipo=tipo_entradas.id inner join fleteras on fleteras.id=recepcion.fletera inner join ubicacion on ubicacion.id=recepcion.ubicacion inner join usuarios on usuarios.id=recepcion.id_empleado_recibe inner join clientes on clientes.pmb=recepcion.pmb inner join planes on clientes.id_plan=planes.id inner join salidas on recepcion.id_salida=salidas.id where date(fecha_entrega)>='$fecha2' and date(fecha_entrega)<='$fecha_hasta2' $and  order by recepcion.id_salida";
//echo"$consulta";
