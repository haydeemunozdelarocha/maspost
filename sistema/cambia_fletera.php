...
if($_POST['guardar']=="Guardar"){
		...
		$id=$_POST['id'];
		$consulta3="update fleteras set nombre=UPPER('".$_POST['nombre']."') where id=$id";
		...
		echo"<script>alert(\"Fletera Guardada\");</script>";
		echo"<script>parent.location=\"fleteras.php\";</script>";

}
$consulta  = "select * from fleteras where id=$id";
			  ...
			  <tr class="">
			   <td class="verde">Logo				</td>
				<td><div class="form-group">
				  ...
				  <p><img src="images/fleteras/<? echo $res[2];?>" width="32" >
