...
$mes_letra=array("","Enero","Febrero","Marzo","Abril","Mayo","Junio","Julio","Agosto","Septiembre","Octubre","Noviembre","Diciembre");
            ...
            <tbody>
              <tr class="">
                <td bgcolor="#FFFFFF"  ><table width="691" border="0" cellpadding="2" cellspacing="3">
                  <tr>
                    <td width="167"><div align="center"><? echo"$mes_letra[$id_mes]";?></div></td>
                    <td colspan="2"><div align="left"><? echo"$pmb $titular $empresa1 $empresa2";?></div></td>
                    </tr>
                  <tr>
                    <td><div align="right">Previous Balance </div></td>
                    <td width="129"><div align="right">$<? echo"$saldo_del_mes_anterior";?></div></td>
                    <td width="371">&nbsp;</td>
                  </tr>
                  <tr>
                    <td><div align="right">Warehouse entries </div></td>
				  ...
				  <tr>
                    <td><div align="right">Renovation</div></td>
                    <td><div align="right">$<? echo"$saldo_renovaciones";?></div></td>
                    <td>&nbsp;</td>
				  </tr>
                  <tr>
                    <td><div align="right">Payments</div></td>
                  ...
                  <tr>
                    <td><div align="right"><strong>New Balance</strong>:</div></td>
                ...
                <td bgcolor="#CCCCCC"  ><table width="1056" class="tablesorter" id="myTable">
                  <thead>
                    ...
                    <tr>
					  ...
					  <th width="3%" bgcolor="#313630" class="style11"><div align="center">PMB</div></th>
                      ...
                      <th width="5%" bgcolor="#313630"><div align="center"><span class="style11">Peso</span></div></th>
                      <th width="9%" bgcolor="#313630" class="style11"> <div align="center">Paq </div></th>
                      <th width="6%" bgcolor="#313630" class="style11"><div align="center">Serv</div></th>
                      <th width="5%" bgcolor="#313630" class="style11"><div align="center">Desc</div></th>
                      <th width="4%" bgcolor="#313630" class="style11"><div align="center">COD</div></th>
                      <th width="8%" bgcolor="#313630"><div align="center"><span class="style11">Total  </span></div></th>
                    </tr>
                  </thead>
                  <tbody>
                    <?
...
?>
                ...
                <table width="637" class="tablesorter" id="myTable">
                  <thead>
                    <tr>
