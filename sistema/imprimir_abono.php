...
$id=$_GET["id"];
	...
	$totalextra=0;
	$consulta  = "SELECT date_format(fecha, '%m/%d/%Y'), monto, pmb, descuento, name, tipo,saldo  from abonos where id=$id ";
...
<table width="858" align="left">
  ...
  <tr>
    <td width="10%" bgcolor="#999999"><div align="center">PAYMENT </div></td>
    <td width="7%" bgcolor="#999999"><div align="center">BALANCE</div></td>
  </tr>
   
  <tr>
    <td><div align="center">$<? echo  number_format($total+$descuento,2);?> <? //echo  number_format($total,2);?><? if($descuento>0){echo"(-$descuento)="; echo  number_format($total,2); }?></div></td>
