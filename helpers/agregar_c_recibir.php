...
$mail->Subject = 'Perfil Actualizado: Agregar Nombre Recibir';
...
<h1 style="padding-top:20px;">Actualizar Perfil: Agregar Cliente para Recibir</h1>

  <p>El cliente con el numero de PMB: <strong>'.$pmbU.'</strong></p>
  <p> Ha solicitado agregar el siguiente nombre de la lista de clientes con autorizacion a recibir:</p>
